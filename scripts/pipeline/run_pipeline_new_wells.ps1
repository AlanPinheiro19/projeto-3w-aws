...
#  Pipeline completo 3W com novo escopo de pocos
#  Pocos: WELL-00001, WELL-00002, WELL-00006
#  Ambiente: conda 3W
#
#  Executa: Ingestao -> ETL (Bronze/Silver/Gold) -> Treino -> Threshold -> SHAP
#  Uso: .\scripts\pipeline\run_pipeline_new_wells.ps1
# ============================================================
...
# Passo 1: Ingestao dos pocos do novo escopo
Step 1 5 "Ingestao dos pocos 00001, 00002, 00006 (todas as classes)..."
...
# Passo 2: ETL em tres camadas (Bronze -> Silver -> Gold)
...
# Passo 3: Treinamento dos modelos baseline
...
# Passo 4: Ajuste de thresholds por classe
...
# Passo 5: Analise SHAP de interpretabilidade
Step 5 5 "SHAP Analysis (interpretabilidade do modelo)..."
