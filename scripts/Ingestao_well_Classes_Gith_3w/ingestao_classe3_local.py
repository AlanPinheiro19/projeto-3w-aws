"""
Script: ingestao_classe3_wells_only.py
Descricao: Ingestion of Class 3 Parquet files from Petrobras 3W dataset.
...
def run_ingestion_pipeline() -> None:
    """
    Execute the complete ingestion pipeline for Class 3 WELL files.
    """
    logger.info("Starting ingestion pipeline for Class 3")
