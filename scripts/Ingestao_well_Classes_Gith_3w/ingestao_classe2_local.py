"""
Script: ingestao_classe2_wells_only.py
Descricao: Ingestion of Class 2 Parquet files from Petrobras 3W dataset.
...
def run_ingestion_pipeline() -> None:
    """
    Execute the complete ingestion pipeline for Class 2 WELL files.
    """
    logger.info("Starting ingestion pipeline for Class 2")
