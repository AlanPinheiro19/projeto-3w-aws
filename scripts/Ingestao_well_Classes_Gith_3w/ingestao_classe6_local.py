"""
Script: ingestao_classe6_wells_only.py
Descricao: Ingestion of Class 6 Parquet files from Petrobras 3W dataset.
...
def run_ingestion_pipeline() -> None:
    """
    Execute the complete ingestion pipeline for Class 6 WELL files.
    """
    logger.info("Starting ingestion pipeline for Class 6")
