"""
Script: ingestao_classe4_wells_only.py
Descricao: Ingestion of Class 4 Parquet files from Petrobras 3W dataset.
...
def run_ingestion_pipeline() -> None:
    """
    Execute the complete ingestion pipeline for Class 4 WELL files.
    """
    logger.info("Starting ingestion pipeline for Class 4")
