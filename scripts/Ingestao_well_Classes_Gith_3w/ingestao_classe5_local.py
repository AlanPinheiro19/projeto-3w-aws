"""
Script: ingestao_classe5_wells_only.py
Descricao: Ingestion of Class 5 Parquet files from Petrobras 3W dataset.
...
def run_ingestion_pipeline() -> None:
    """
    Execute the complete ingestion pipeline for Class 5 WELL files.
    """
    logger.info("Starting ingestion pipeline for Class 5")
