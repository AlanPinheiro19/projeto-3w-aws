...
#  Executa: Gold (por poco) -> Treino RF/XGB/LGB -> Threshold -> SHAP
#  Ambiente: conda 3W
#
#  Uso (a partir da raiz do projeto OU de qualquer pasta):
#    .\scripts\pipeline\run_gold_and_train.ps1
# ============================================================
...
# Passo 0: Limpa apenas o Gold (Bronze e Silver preservados)
...
# Passo 2: Gold por poco (eficiente em memoria - processa um poco por vez)
...
# Passo 3: Gold final (normalizacao Z-score global + split estratificado 70/15/15)
...
# Passo 4: Treinamento dos tres modelos baseline
...
# Passo 5: Ajuste de thresholds por classe (melhora F1-macro)
...
# Passo 6: Analise SHAP (interpretabilidade do modelo LightGBM)
Step 6 6 "Instalando SHAP e executando analise de interpretabilidade..."
