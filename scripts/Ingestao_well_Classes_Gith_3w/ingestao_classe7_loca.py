"""
Script: ingestao_classe7_wells_only.py
Descricao: Ingestion of Class 7 Parquet files from Petrobras 3W dataset.
...
def run_ingestion_pipeline() -> None:
    """
    Execute the complete ingestion pipeline for Class 7 WELL files.
    """
    logger.info("Starting ingestion pipeline for Class 7")
