"""
Script: ingestao_classe9_wells_only.py
Descricao: Ingestion of Class 9 Parquet files from Petrobras 3W dataset.
...
def run_ingestion_pipeline() -> None:
    """
    Execute the complete ingestion pipeline for Class 9 WELL files.
    """
    logger.info("Starting ingestion pipeline for Class 9")
